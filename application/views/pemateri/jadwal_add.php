          ...
          <div class="card">
            <div class="card-body">
              <div class="table-responsive">
                <form class="form-horizontal" method="post" action="<?=base_url('Pemateri/'.$action.'Jadwal/'.$id)?>">
                  <div class="form-group">
                    <label class="col-md-2 control-label" for="inputNamaPelatihan">Pemateri</label>
                    <div class="col-md-8">
                      <select id="" class="form-control col-md-8" name="pemateri" readonly required>
                        <option value="<?=$pemateri->id?>"><?=$pemateri->namalengkap?></option>
                      </select>
                    </div>
                  </div>
